...
@InputType()
class StudentProfileCreateNestedManyWithoutClassModelsInput {
...
export { StudentProfileCreateNestedManyWithoutClassModelsInput as StudentProfileCreateNestedManyWithoutClassModelsInput };
