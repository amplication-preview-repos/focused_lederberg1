...
@InputType()
class AttendanceCreateNestedManyWithoutSchoolsInput {
...
export { AttendanceCreateNestedManyWithoutSchoolsInput as AttendanceCreateNestedManyWithoutSchoolsInput };
