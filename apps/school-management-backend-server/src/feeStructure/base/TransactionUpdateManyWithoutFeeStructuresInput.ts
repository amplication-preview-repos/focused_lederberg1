...
@InputType()
class TransactionUpdateManyWithoutFeeStructuresInput {
...
export { TransactionUpdateManyWithoutFeeStructuresInput as TransactionUpdateManyWithoutFeeStructuresInput };
