...
class FeeStructureUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => TransactionUpdateManyWithoutFeeStructuresInput,
  })
  @ValidateNested()
  @Type(() => TransactionUpdateManyWithoutFeeStructuresInput)
  @IsOptional()
  @Field(() => TransactionUpdateManyWithoutFeeStructuresInput, {
    nullable: true,
  })
  transactions?: TransactionUpdateManyWithoutFeeStructuresInput;
}

export { FeeStructureUpdateInput as FeeStructureUpdateInput };
